...
public class NewJFrame extends javax.swing.JFrame
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            FileDownloader.downloadFile(url,tempFile, new FileDownloaderCallback()
            {
                @Override
                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run()
                            {
                                try
                                {
                                    ...
                                    FileDownloader.downloadFile(fileURL, tempFile, new FileDownloaderCallback()
                                    {
                                        @Override
                                        public void totalBytesDownloaded(long bytes, boolean finished, boolean failed)
                                        {
                                            jLabel2.setIcon((Icon) tempFile);
                                        }
                                    });
                                    ////////////////////////////////////////
                                    jList1.updateUI();
